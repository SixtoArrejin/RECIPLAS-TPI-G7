    ...
    return (
        <div className="Page">
            <div className="ParteSuperior">
                ...
                <h1 style={{ margin: "0" }}>MODIFICAR DATOS DE USUARIO</h1>
            </div>
            <div className="Caja">
                <Datos />
                <div
                ...
                >
                    ...
                    >
                        <div>
                            <div className="modal-header">
                                <div className="modal-title">Cancelar modificación</div>
                                <div>
                    ...
                    >
                        <div>
                            <div className="modal-header">
                                <div className="modal-title">Guardar detalles de usuario</div>
                                <div>
